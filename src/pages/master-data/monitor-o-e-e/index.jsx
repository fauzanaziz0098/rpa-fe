    ...
    //   perfomance
      ...
      useEffect(() => {
        ...
        const calculateAvailabilityPercentage = () => {
          ...
          // oee
          const calculateRingProgressPercentage = () => {
              if (activePlan.length === 0 || qtyActual === 0 || cycleTime === 0) {
                  return 0;
              }
      
              const ringProgressPercentage = (qtyActual * cycleTime) / timeDifference;
              return ringProgressPercentage;
          };
      
          const ringProgressPercentage = calculateRingProgressPercentage();
  ...
  return (
    <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '-260px' }}>
            <RingProgress sections={[{ value: ringProgressPercentage, color: 'green' }]} label={ <Text c="green" fw={700} ta="center"
                size="xl">
                    {ringProgressPercentage.toFixed(0)}%
                </Text>
                }
                size={500}
                />
